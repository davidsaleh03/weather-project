              ...
              <div className="quality__more--module-top">
                ...
                <div className="quality__more--module-1">
                  <div className="forecast__condition--container">
                    <h1 className="forecast__condition--h1">UV : 0.7</h1>
                    <h1 className="forecast__condition--h1">CO : 370</h1>
                    <h1 className="forecast__condition--h1">NO2 : 55</h1>
                    <h1 className="forecast__condition--h1">O3 : 29</h1>
                    <h1 className="forecast__condition--h1">SO2 : 18</h1>
                  </div>
                </div>
                <div className="quality__more--module-1">
                  <div className="forecast__humid2">
